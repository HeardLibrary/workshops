...
categories: tech
description: "This workshop covers the fundamentals of XQuery, a programming language originally designed to query large amounts of XML data but now also used to query other kinds of data like JSON."
---
