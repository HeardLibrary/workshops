...
The goals of this workshop are
  ...
  * to explain how XQuery differs from other, more familiar programming languages;
  * to teach the basics of FLWOR expressions, which constitute the core of XQuery;
  * to show how to write conditional expressions in XQuery;
  * to demonstrate how to write your own functions in Xquery;

At the end of this workshop, I've placed several exercises for you to practice with. By the time you've finished these practice sets, you'll be able to write basic queries and will be ready to move on to more advanced topics.

## Introduction to Functional Programming with XQuery
...
## Problem Sets: Pig Latin in XQuery
...
Remember that recursion always requires a base case. In my example, the base case works most of the time but will not always work. Can you create an example where it will fail? Actually, don't try this in class–recursion is painful to the nth degree when it fails.* 
